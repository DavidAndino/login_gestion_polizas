        ...
        <div id="page-content-wrapper">
                    ...
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle second-text fw-bold" href="#" id="navbarDropdown"
                                ...
                                <i class="fas fa-user me-2"></i>Contador
                            </a>
            ...
            <div class="container-fluid px-4">
                <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                    <button class="btn btn-success me-md-4" type="button">Nuevo</button>
                    <button class="btn btn-success me-md-4" type="button">Editar empleado</button>
                    <button class="btn btn-success me-md-4" type="button">Lista siniestro</button>
